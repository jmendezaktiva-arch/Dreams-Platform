...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const injectSectionTemplates = () => {
        ...
        [1,2].forEach(i => document.getElementById('puestos-grid').innerHTML += `
            <div class="bg-gray-50/50 p-8 rounded-3xl border border-gray-100">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <input type="text" class="autosave-input p-3 rounded-xl border-none shadow-sm text-sm" data-id="vocacion_p${i}_titulo" placeholder="Título del Puesto">
                    <input type="text" class="autosave-input p-3 rounded-xl border-none shadow-sm text-sm" data-id="vocacion_p${i}_antiguedad" placeholder="Antigüedad de la persona">
                </div>
        ...
        document.getElementById('roleplay').innerHTML = `
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div class="p-8 bg-green-50/30 rounded-[2.5rem] border border-green-50">
                    <h5 class="text-green-800 font-black text-[10px] uppercase mb-4 tracking-widest text-center">Fortalezas del Líder</h5>
                    <textarea class="autosave-input w-full p-4 bg-white border-none rounded-3xl h-48 text-xs font-medium" data-id="rp_aciertos" placeholder="Ej: Claridad al explicar el impacto del error..."></textarea>
                </div>
                <div class="p-8 bg-orange-50/30 rounded-[2.5rem] border border-orange-50">
                    <h5 class="text-orange-800 font-black text-[10px] uppercase mb-4 tracking-widest text-center">Oportunidades de Mejora</h5>
                    <textarea class="autosave-input w-full p-4 bg-white border-none rounded-3xl h-48 text-xs font-medium" data-id="rp_mejoras" placeholder="Ej: No interrumpir al colaborador durante su autoevaluación..."></textarea>
                </div>
            </div>`;
            ...
            <div class="grid grid-cols-2 gap-8">
                ${[1,2].map(i => `
                    <div class="p-6 border border-gray-100 rounded-[2rem]">
                        <h6 class="font-black text-[#0F3460] text-[10px] uppercase mb-3 underline decoration-[#957C3D] underline-offset-4">${gV('vocacion_p'+i+'_titulo')}</h6>
